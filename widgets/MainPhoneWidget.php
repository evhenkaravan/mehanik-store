...
final class MainPhoneWidget extends WP_Widget
{
    function __construct() {
        parent::__construct(
            'MainPhoneWidget',
            __('Mehanik-store Main Phone Widget', 'mehanik-store'),
            ['description' => __( 'Widget for main phone number', 'mehanik-store' )]
        );
    }
